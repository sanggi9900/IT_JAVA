...
public class Ex04 {
	public static void main(String[] args) {
		...
		// 자바 객체지향 언어이므로, 모든 값은 객체 형태롤 나타내야 한다
        ...
        float fl = 1.2F;		// 기본자료형이 아니기 때문에 float임믈 명시한다
		double db = 3.14;
				
		// The value of the local variable bo is not used
		// 지역 변수 bo는 아직 한번도 사용되지 않았습니다.
		// 변수는 나중에 값을 다시 사용하기 위해서 만드느건데, 왜 한번도 안했지?
		...
		// 대입 : 오른쪽의 값을 왼족 변수 공간에 복사하여 저장한다
		// 왼쪽과 오른쪽 같지 않아도 되지만, 자료형은 같아야한다
//		int num = "점심식사";
		
		// 이미 선언된 변수는 자료형이 나타나지 않지만, 툴팁이나 링크 따라가
//		age = "배고파";
		
		// 양쪽다 변수를 나타내고 있지만
		// 오른쪽의 변수는 변수에 담긴 값을 의미하고
		// 왼쪽 변수는 변수공간 그 자체를 의미한다
