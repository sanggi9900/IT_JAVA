...
public class Quiz1 {
	public static void main(String[] args) {
		...
		// - 페이지 당 게시글 출력 객수는 10개이다
		// - 하나의 게시글이라도 생략되면 안된다
		// - 총 게시글 수는 10000 ~ 99999 사이이다
		// - 요청으로 읽어 들여야 할 게시글의 페이지 번호가 제시된다
	...
	//	int page = 13;
			int begin = page*10 -9 , 			end = page*10 ;		// page를 이용하여 begin을 구하는 식
	//			begin = (page - 1) * 10 + 1   	end = begin + 9;	// begin을 이용하여 end를 구하는 식
		if(end > boardCount ) end = boardCount ;
		
		System.out.println("총 게시글의 개수 : " + boardCount);
		System.out.println("총 페이지 수 : " + pageCount);
		System.out.println("요청받는 페이지 : " + page);
